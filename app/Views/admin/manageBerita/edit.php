...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="<?= site_url('manage-berita') ?>"><i class="fas fa-arrow-left"></i></a>
        </div>
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body p-0">
                <form method="post" action="<?= site_url('manage-berita/update/'. $data->id) ?>" enctype="multipart/form-data" class="pl-4 pr-4">
                    <?= csrf_field(); ?>
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3 mt-2">
                            <article class="article article-style-b">
                                <div class="article-header">
                                    ...
                                    <div class="article-image" data-background="<?= base_url() . "/uploads/berita/" . $data->gambar; ?>">
                                    </div>
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="summernote-simple" value="s" style="display: none;"><?= $data->description ?></textarea>

                        <!-- <input type="text" name="description" value="<?= old('description') ?>"  class="form-control" aria-describedby="passwordHelpBlock" autocomplete="off"> -->
