    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body p-0">
                <form method="post" action="<?= site_url('manage-berita/store') ?>" enctype="multipart/form-data" class="pl-4 pr-4" >
                    <?= csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="summernote-simple" value="s" style="display: none;"><?=old('description')?></textarea>
