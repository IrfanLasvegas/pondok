    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body p-0">
                <form method="post" action="<?= site_url('manage-detail-keuangan/store') ?>" enctype="multipart/form-data" class="pl-4 pr-4" >
                    <?= csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nominal" id="nominal" value="<?= old('nominal') ?>"  class="form-control" aria-describedby="passwordHelpBlock" autocomplete="off">
