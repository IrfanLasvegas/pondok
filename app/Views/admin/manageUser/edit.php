    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body p-0">
                <form method="post" action="<?= site_url('manage-user/update/' . $data->id) ?>" class="pl-4 pr-4" >
                    <?= csrf_field(); ?>
                    <input type="hidden" name="_method" value="PUT"> 
                    <div class="form-group">
                        <label for="password">Nama</label>
                        <input type="text" name="username" value="<?= $data->username ?>"  class="form-control" aria-describedby="passwordHelpBlock" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" value="<?= $data->email ?>"  class="form-control" aria-describedby="passwordHelpBlock" autocomplete="off">
