...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="<?= site_url('manage-mahasiswa')?>"><i class="fas fa-arrow-left"></i></a>
        </div>
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body p-0">
                <form method="post" action="<?= site_url('manage-mahasiswa/update/' . $data->id) ?>" class="pl-4 pr-4">
                    <?= csrf_field(); ?>
...
<script>
    function allParent() {
        ...
        // console.log("<?= site_url('manage-take-parent') ?>/"+id);
        $.ajax({
            url: "<?php echo site_url('manage-take-parent') ?>/" + id,
            headers: {
            ...
            success: function(response) {
                let urlEdit = "<?= site_url('manage-orang-tua/edit') ?>/"
                ...
                if (response.success == 1) {
                    ...
                    $.each(response.data, function(key, value) {
                        ...
                        data = data + "<td>"
                        data = data + "<a title='Edit' href=" + urlEdit + value.orang_tuas_id + " class='btn btn-warning'><i class='fas fa-pencil-alt'></i></a>"
    ...
    function addDatav() {
        ...
        $.ajax({
            url: "<?php echo site_url('manage-mhsortu/create'); ?>",
            headers: {
                'X-Requested-With': 'XMLHttpRequest'
            },
            type: 'post',
        ...
        Swal.fire({
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?php echo site_url('manage-mhsortu/delete'); ?>",
                        headers: {
                            'X-Requested-With': 'XMLHttpRequest'
                        },
                        type: 'post',
