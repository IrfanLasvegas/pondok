    ...
    <div class="section-body">
        <div class="card ">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-sm align-middle"><?= $row->status; ?></td>
                                    <td class="text-sm align-middle"><?= $row->created_at; ?></td>
                                    <td>
                                        <a title="Edit" href="<?= base_url("manage-mahasiswa/edit/" . $row->id); ?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                        <form action="<?= base_url("manage-mahasiswa/delete/" . $row->id) ?>" method="post" class="d-inline" id="formDel<?= $row->id ?>">
                                            <?= csrf_field(); ?>
            ...
            <div class="card-footer text-right">
                ...
                <?= $pager->links('group_mahasiswa', 'custom_pager1') ?>
