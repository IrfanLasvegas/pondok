...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/customStylePondok.css">
    ...
    <script src="<?= base_url() ?>/template/assets/js/sweetalert2/sw.min.js"></script>
        ...
        <div class="main-wrapper">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <form class="form-inline mr-auto">
                    ...
                    <?= $this->renderSection('content-search') ?>
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="<?=site_url()?>">pesantren</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="<?=site_url()?>">St</a>
                    </div>
                    <ul class="sidebar-menu">
                    <?= $this->include('layout1/menu') ?>
                    </ul>
